  ...
  <t-row :gutter="[24, 24]">
    <t-col :flex="3">
      <div class="user-left-greeting">
        ...
        <img :src="GREETING_BANNER_URL" class="logo" alt="农田实景" />
      </div>
    ...
    <t-col :flex="1">
      <t-card class="user-intro" :bordered="false">
        <t-avatar size="80px" :image="PROFILE_AVATAR_URL" />
      ...
      <t-card :title="t('pages.user.serviceProduction')" class="product-container" :bordered="false">
        ...
        <t-row class="content" :getters="16">
          <t-col v-for="(item, index) in PRODUCT_LIST" :key="index" :span="3">
            <img :src="item.image" :alt="item.alt" class="service-image" />
          </t-col>
        </t-row>
      </t-card>
    </t-col>
...
import { GREETING_BANNER_URL, PRODUCT_LIST, PROFILE_AVATAR_URL, TEAM_MEMBERS, USER_INFO_LIST } from './constants';
